            ...
            >
              <div className="flex items-start justify-between gap-2">
                <div className="min-w-0 flex-1">
                  ...
                  {doc.file_path && (
                    <p className="text-[10px] font-mono text-text-tertiary truncate mt-0.5" title={doc.file_path}>
              ...
              <div className="flex flex-wrap gap-1 mt-2">
                {doc.file_type && (
                  <span className="px-1.5 py-0.5 rounded text-[9px] bg-bg-tertiary text-text-tertiary font-mono">
                    {doc.file_type}
                  </span>
                )}
                {doc.source && (
                ...
                {(doc.metadata?.conversation_title as string | undefined) && (
                                  <span
                                    className="px-1.5 py-0.5 rounded text-[9px] bg-accent-primary/10 text-accent-primary font-mono truncate max-w-[120px]"
