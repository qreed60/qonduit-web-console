...
const RagProjectCard: React.FC<RagProjectCardProps> = ({
  ...
  return (
      <div
        className={`bg-bg-card rounded-xl border p-3 sm:p-4 cursor-pointer transition-all duration-200 hover:border-border-primary/60 ${
          isSelected
        ...
        <div className="flex items-start justify-between mb-2">
          <div className="flex items-center gap-2 min-w-0 flex-1">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] font-mono text-text-tertiary truncate hidden sm:block" title={project.qdrant_collection}>
