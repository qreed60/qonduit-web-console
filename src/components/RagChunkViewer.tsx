...
const RagChunkViewer: React.FC<RagChunkViewerProps> = ({
  ...
  return (
      <div className="bg-bg-card rounded-xl border border-border-primary p-4 sm:p-5 shadow-card">
        ...
        {documentName && (
          <p className="text-[10px] sm:text-xs text-text-tertiary mb-3 truncate" title={documentName}>
                ...
                >
                  ...
                  {isExpanded && (
                    <div className="px-3 pb-3 space-y-2">
                      {/* Text preview/full */}
                      <div>
                        <p className="text-[10px] sm:text-xs text-text-tertiary uppercase tracking-wider mb-1">Text</p>
                      ...
                      {chunk.payload && Object.keys(chunk.payload).length > 0 && (
                        <div>
                          <p className="text-[10px] sm:text-xs text-text-tertiary uppercase tracking-wider mb-1">Metadata</p>
                          <div className="flex flex-wrap gap-1 overflow-x-auto -mx-1 px-1">
                      ...
                      <button
                        ...
                        className="text-[10px] sm:text-xs text-accent-primary hover:text-accent-primary-hover transition-colors"
                      >
